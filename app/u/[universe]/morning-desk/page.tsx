...
// deduped; a pre-open morning run + a post-close evening run) and the Reuters news wire (Morning
// News Call + The Day Ahead) as two sub-tabs of one page. Universe-independent (US/S&P 500-keyed).
// ?tab=wire deep-links the news wire (old /briefing bookmarks redirect there).
    ...
    <main className="mx-auto max-w-[72rem] px-4 py-6 sm:px-6">
      <div className="mb-4">
        ...
        <p className="mt-1 max-w-3xl text-xs text-[var(--text-3)]">
          The AI desk brief — biggest moves, material SEC filings, unusual options flow, and analyst actions, fused into one read (a pre-open <b>morning run</b> and a post-close <b>evening run</b> each weekday). The day&apos;s Reuters wire sits on the <b>News Wire</b> tab. Research / decision-support, not investment advice.
        </p>
      </div>
