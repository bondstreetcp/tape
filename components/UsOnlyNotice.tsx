  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] px-6 py-10 text-center">
        ...
        <h1 className="mt-3 text-xl font-bold">{label} covers US-listed options only</h1>
        <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-[var(--text-3)]">
          This desk is built on US single-stock options &amp; earnings data, which isn&apos;t available
