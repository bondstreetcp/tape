...
// Every tile — index or not — opens its history chart in place. (Index tiles used to hijack the
// click out to that index's heatmap page, which read as a "market heatmap" bolted onto this monitor.)
function TileCard({ t, onClick }: { t: Tile; onClick: () => void }) {
  ...
  return (
    <button onClick={onClick} title={`View ${t.name} history`} className={cls}>
