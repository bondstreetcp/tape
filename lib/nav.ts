...
export const GROUP_HUBS: Partial<Record<NavGroup, NavHub[]>> = {
  Strategies: [
    ...
    { label: "Earnings & Events", blurb: "Trade the event — start at the Earnings Season Desk, then the weekly AI trade desk, the week-ahead earnings moves, implied vs. historical move, skew & term-structure setups, cheap options into a catalyst, where vol is rich/cheap, and who sandbags their own guide", paths: ["/earnings-desk", "/trade-desk", "/earnings-week", "/earnings-move", "/earnings-setup", "/track-record", "/catalyst-vol", "/vol-dislocation", "/skew", "/term-structure", "/dispersion", "/pead", "/seasonality", "/guidance"] },
