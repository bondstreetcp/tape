...
export const GROUP_HUBS: Partial<Record<NavGroup, NavHub[]>> = {
  ...
  Research: [
    ...
    { label: "Prism (Your Book)", blurb: "Prism — your book's risk engine, factor attribution + solved hedges, the catalyst radar, and covered-call income on your longs", paths: ["/portfolio", "/portfolio-radar", "/portfolio-income"] },
  ],
};
