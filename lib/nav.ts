...
export const FEATURES: NavItem[] = [
  ...
  { label: "Spinoff Turnover", path: "/spinoffs", desc: "Completed spinoffs with the share-register turnover clock — ~50% turned has historically marked the bottom", group: "Event-Driven", job: "Find ideas", kw: "spinoff spin-off turnover when-issued forced selling seller exhaustion greenblatt special situations bottom" },
