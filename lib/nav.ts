...
export const FEATURES: NavItem[] = [
  ...
  { label: "Realized-Vol Cone", path: "/vol-cone", desc: "Where each name's current realized vol sits in its own historical cone — coiled (quiet, breakout risk) vs blown-out (mean-revert)", group: "Strategies", job: "Find ideas", kw: "realized volatility cone historical vol hv rv percentile burghardt lane coiled quiet compressed blown out spike mean reversion breakout term structure expanding contracting 20 day 60 day annualized standard deviation vol regime cheap gamma" },
  { label: "Coiled Springs", path: "/coiled", desc: "Cheap realized vol + a dealer-gamma accelerant — names set up for an outsized move (vol cone × gamma board)", group: "Strategies", job: "Find ideas", kw: "coiled spring cheap vol low realized volatility short gamma flip breakout setup pre move optionality buy straddle strangle vol gamma fusion accelerant squeeze compression pinned blown out mispriced options confluence" },
