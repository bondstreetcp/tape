...
export const FEATURES: NavItem[] = [
  ...
  { label: "Ratio & Spread", path: "/ratio", desc: "Plot one security against another — A÷B relative strength, spread, or rebased", group: "Research", job: "Research a name", kw: "ratio spread relative strength pairs rebased rs chart divided by versus" },
