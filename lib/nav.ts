...
export const FEATURES: NavItem[] = [
  ...
  { label: "Earnings Odds", path: "/earnings-odds", desc: "Polymarket's P(beat) per reporter vs the frozen EPS bar, consensus drift, and the options-implied move", group: "Options", job: "Find ideas", kw: "earnings odds polymarket prediction market beat miss probability eps bar strike consensus drift crowd" },
...
export const GROUP_HUBS: Partial<Record<NavGroup, NavHub[]>> = {
  ...
  Options: [
    ...
    { label: "Earnings Vol", blurb: "Trade the print — this week's reporters, implied vs. historical move, the prediction-market odds, setup cards, post-earnings drift, guidance, and the live track records", paths: ["/earnings-week", "/earnings-move", "/earnings-odds", "/earnings-setup", "/pead", "/guidance", "/track-record", "/preview-record"] },
