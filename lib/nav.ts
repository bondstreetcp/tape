...
export const GROUP_HUBS: Partial<Record<NavGroup, NavHub[]>> = {
  Strategies: [
    ...
    { label: "Earnings & Events", blurb: "Trade the event — the weekly AI trade desk, implied vs. historical move, a live track record, cheap options into a catalyst, where vol is rich/cheap, and who sandbags their own guide", paths: ["/trade-desk", "/earnings-move", "/earnings-setup", "/track-record", "/catalyst-vol", "/vol-dislocation", "/guidance"] },
