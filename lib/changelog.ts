...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      "Macro → Real economy — a free dashboard of primary-source alt-data across the whole economy: broad activity (Chicago Fed CFNAI + the Chicago Fed business-conditions survey, the Weekly Economic Index, financial conditions), manufacturing (regional-Fed PMIs — the free ISM stand-in — industrial production, capacity use, core capex), a new Services read (NY / Philadelphia / Dallas Fed service-sector surveys — the free stand-in for the licensed ISM Services, which is ~70% of the economy), freight (rail carloads/intermodal, a truck-freight index + the Cass Freight Index, inventories-to-sales), the consumer (retail sales, durable goods, autos), prices & inflation (sticky-price core CPI, trimmed-mean PCE, consumer + market inflation expectations, and wage growth), money & credit (business & consumer loan growth, M2, bank lending standards from the SLOOS, and card delinquencies), the labor market (weekly jobless claims plus two leading reads — the JOLTS quits rate and temp-help payrolls), air travel (TSA), and housing (starts, permits, new-home sales, the 30-yr mortgage). Every card clicks into a full chart with selectable timeframes + labeled axes and a hover explainer, topped by an AI desk read of what it's signaling.",
