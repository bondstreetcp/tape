...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Macro → Valuation — long-run index trend channels: a log-price regression with ~68%/95% bands for the S&P 500 (fit since 1932), Nasdaq & Russell 2000, showing how far each sits above/below its long-term growth trend (a cheap/dear read, with a z-score gauge). Descriptive, not predictive.",
