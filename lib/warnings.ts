...
export type WarningKind = "expensive" | "estcuts" | "distribution" | "downgrade" | "guidancecut" | "putflow";
...
export const WARNING_ORDER: WarningKind[] = ["expensive", "estcuts", "distribution", "guidancecut", "downgrade", "putflow"];
